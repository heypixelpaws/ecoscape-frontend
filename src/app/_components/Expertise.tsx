    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-white to-gray-50">
      <div className="wrapper py-20">
        <div className="mb-16 text-center">
          <h2 className="text-4xl font-medium tracking-tight sm:mx-auto sm:max-w-2xl md:text-5xl md:leading-[3.5rem]">
            Our Areas of{" "}
            <span className="ml-1 font-bold text-[#4CAF50]">Expertise</span>
          </h2>
          ...
          {expertise.map((item) => (
            ...
            >
              <CardHeader className="relative">
                ...
                <div className="relative h-48 w-full overflow-hidden rounded-t-lg md:h-52 lg:h-60">
                  <Image
